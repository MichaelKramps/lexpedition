...
class _BuildTwoPlayerPuzzleWidgetState
      ...
      Row(children: [
        ...
        Column(children: [
          ...
          Listener(
              ...
              child: Column(children: [
                for (var row in getSelectedGrid().rows) ...[
                  Row(children: [
                    for (var letterTile in row) ...[
                      LetterTileWidget(
                          letterTile: letterTile,
                          blastDirection: getSelectedGrid().blastDirection)
                    ]
                  ])
                ]
              ]))
  ...
  void selectTile(event) {
    ...
    if (selectedIndex == _selectedIndex) {
      ...
      setState(() {
        if (_selectedIndex > -1) {
          getSelectedGrid().letterTiles[_selectedIndex].unselect();
        }
        _selectedIndex = selectedIndex;
        getSelectedGrid().letterTiles[selectedIndex].select();
      });
    }
  }
